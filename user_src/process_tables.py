    ...
    def display_table_coordinates(self):
        for index, table in enumerate(self.tables):
            ...
            if all_coords:
                ...
                self.tables[index].corner_coords = [top_left_xl, bottom_left_xl, top_right_xl, bottom_right_xl]
                print(f"Table {index}:")    
